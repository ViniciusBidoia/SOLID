...
namespace SOLID.ConsoleApp.SRP.Violacao
{
    /// <summary>
    /// Reparem que quebra todos os principios de responsabilidade unica, deixando a classe cliente responsavel por fazer tudo
    /// </summary>
